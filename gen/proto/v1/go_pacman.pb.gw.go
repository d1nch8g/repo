...
func RegisterPacmanServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PacmanServiceServer) error {
	...
	mux.Handle("PUT", pattern_PacmanService_Add_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.v1.PacmanService/Add", runtime.WithHTTPPathPattern("/addpkg"))
		if err != nil {
...
func RegisterPacmanServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PacmanServiceClient) error {
	...
	mux.Handle("PUT", pattern_PacmanService_Add_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.v1.PacmanService/Add", runtime.WithHTTPPathPattern("/addpkg"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_PacmanService_Add_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"addpkg"}, ""))
