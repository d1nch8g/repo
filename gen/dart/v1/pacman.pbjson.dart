...
const StatsResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'outdated_packages', '3': 3, '4': 3, '5': 9, '10': 'outdatedPackages'},
  ],
};

/// Descriptor for `StatsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List statsResponseDescriptor = $convert.base64Decode('Cg1TdGF0c1Jlc3BvbnNlEiUKDnBhY2thZ2VzX2NvdW50GAEgASgFUg1wYWNrYWdlc0NvdW50EiUKDm91dGRhdGVkX2NvdW50GAIgASgFUg1vdXRkYXRlZENvdW50EisKEW91dGRhdGVkX3BhY2thZ2VzGAMgAygJUhBvdXRkYXRlZFBhY2thZ2Vz');
